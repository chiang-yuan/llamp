...
class SummarySchema(BaseModel):
    ...
    elements: str | None = Field(None, description="Query by elements in the material composition as a comma-separated list")
    exclude_elements: str | None = Field(None, description="Query by excluded elements in the material composition as a comma-separated list")
    possible_species: str | None = Field(
        None,
        description="Comma delimited list of element symbols appended with oxidation states.",
        examples=["Cr2+,O2-"]
        )
    spacegroup_number: str | None = Field(None, description="Query by spacegroup number")
    is_stable: bool | None = Field(None, description="Whether the material is stable")
    theoretical: bool | None = Field(None, description="Whether the material is theoretical")
    is_gap_direct: bool | None = Field(None, description="Whether a band gap is direct or not")
    ...
    nsites: int | None = Field(None, description="Query for nsites being equal to an exact value")
    nsites_not_eq: int | None = Field(None, description="Query for nsites not being equal to an exact value")
    nsites_eq_any: int | None = Field(None, description="Query for nsites being equal to any value in a comma separated list")
    nsites_neq_any: int | None = Field(None, description="Query for nsites not being equal to any value in a comma separated list")
    ...
    nelements: int | None = Field(None, description="Query for nelements being equal to an exact value")
    nelements_not_eq: int | None = Field(None, description="Query for nelements not being equal to an exact value")
    nelements_eq_any: int | None = Field(None, description="Query for nelements being equal to any value in a comma separated list")
    nelements_neq_any: int | None = Field(None, description="Query for nelements not being equal to any value in a comma separated list")
    ...
    density_atomic_max: float | None = Field(None, description="Maximum atomic density in atoms/Å^3")
    density_atomic_min: float | None = Field(None, description="Minimum atomic density in atoms/Å^3")
    uncorrected_energy_per_atom_max: float | None = Field(None, description="Maximum uncorrected energy per atom in eV/atom")
    uncorrected_energy_per_atom_min: float | None = Field(None, description="Minimum uncorrected energy per atom in eV/atom")
    energy_per_atom_max: float | None = Field(None, description="Maximum energy per atom in eV/atom")
    energy_per_atom_min: float | None = Field(None, description="Minimum energy per atom in eV/atom")
    formation_energy_per_atom_max: float | None = Field(None, description="Maximum formation energy per atom in eV/atom")
    formation_energy_per_atom_min: float | None = Field(None, description="Minimum formation energy per atom in eV/atom")
    energy_above_hull_max: float | None = Field(None, description="Maximum energy above hull in eV/atom")
    energy_above_hull_min: float | None = Field(None, description="Minimum energy above hull in eV/atom")
    equilibrium_reaction_energy_per_atom_max: float | None = Field(None, description="Maximum equilibrium reaction energy per atom in eV/atom")
    equilibrium_reaction_energy_per_atom_min: float | None = Field(None, description="Minimum equilibrium reaction energy per atom in eV/atom")
    ...
    dos_energy_up_max: float | None = Field(None, description="Maximum spin-up DOS energy in eV")
    dos_energy_up_min: float | None = Field(None, description="Minimum spin-up DOS energy in eV")
    dos_energy_down_max: float | None = Field(None, description="Maximum spin-down DOS energy in eV")
    dos_energy_down_min: float | None = Field(None, description="Minimum spin-down DOS energy in eV")
    ...
    total_magnetization_normalized_vol_min: float | None = Field(None, description="Minimum normalized total magnetization in Bohr magnetons/Å^3")
    total_magnetization_normalized_formula_units_max: float | None = Field(None, description="Maximum normalized total magnetization in Bohr magnetons/formula unit")
    total_magnetization_normalized_formula_units_min: float | None = Field(None, description="Minimum normalized total magnetization in Bohr magnetons/formula unit")
    num_magnetic_sites_max: int | None = Field(None, description="Maximum number of magnetic sites")
    num_magnetic_sites_min: int | None = Field(None, description="Minimum number of magnetic sites")
    num_magnetic_sites: int | None = Field(None, description="Query for num_magnetic_sites being equal to an exact value")
    num_magnetic_sites_not_eq: int | None = Field(None, description="Query for num_magnetic_sites not being equal to an exact value")
    num_magnetic_sites_eq_any: int | None = Field(None, description="Query for num_magnetic_sites being equal to any value in a comma separated list")
    num_magnetic_sites_neq_any: int | None = Field(None, description="Query for num_magnetic_sites not being equal to any value in a comma separated list")
    num_unique_magnetic_sites_max: int | None = Field(None, description="Maximum number of unique magnetic sites")
    num_unique_magnetic_sites_min: int | None = Field(None, description="Minimum number of unique magnetic sites")
    num_unique_magnetic_sites_not_eq: int | None = Field(None, description="Query for num_unique_magnetic_sites not being equal to an exact value")
    num_unique_magnetic_sites_eq_any: int | None = Field(None, description="Query for num_unique_magnetic_sites being equal to any value in a comma separated list")
    k_voigt_max: float | None = Field(None, description="Maximum Voigt bulk modulus in GPa")
    k_voigt_min: float | None = Field(None, description="Minimum Voigt bulk modulus in GPa")
    k_reuss_max: float | None = Field(None, description="Maximum Reuss bulk modulus in GPa")
    k_reuss_min: float | None = Field(None, description="Minimum Reuss bulk modulus in GPa")
    k_vrh_max: float | None = Field(None, description="Maximum Voigt-Reuss-Hill bulk modulus in GPa")
    k_vrh_min: float | None = Field(None, description="Minimum Voigt-Reuss-Hill bulk modulus in GPa")
    g_voigt_max: float | None = Field(None, description="Maximum Voigt shear modulus in GPa")
    g_voigt_min: float | None = Field(None, description="Minimum Voigt shear modulus in GPa")
    g_reuss_max: float | None = Field(None, description="Maximum Reuss shear modulus in GPa")
    g_reuss_min: float | None = Field(None, description="Minimum Reuss shear modulus in GPa")
    g_vrh_max: float | None = Field(None, description="Maximum Voigt-Reuss-Hill shear modulus in GPa")
    g_vrh_min: float | None = Field(None, description="Minimum Voigt-Reuss-Hill shear modulus in GPa")
    universal_anisotropy_max: float | None = Field(None, description="Maximum universal anisotropy")
    universal_anisotropy_min: float | None = Field(None, description="Minimum universal anisotropy")
    homogeneous_poisson_max: float | None = Field(None, description="Maximum homogeneous Poisson ratio")
    homogeneous_poisson_min: float | None = Field(None, description="Minimum homogeneous Poisson ratio")
    ...
    weighted_surface_energy_EV_PER_ANG2_min: float | None = Field(None, description="Minimum weighted surface energy in eV/Å^2")
    weighted_surface_energy_max: float | None = Field(None, description="Maximum weighted surface energy in J/m^2")
    weighted_surface_energy_min: float | None = Field(None, description="Minimum weighted surface energy in J/m^2")
    weighted_work_function_max: float | None = Field(None, description="Maximum weighted work function in eV")
    weighted_work_function_min: float | None = Field(None, description="Minimum weighted work function in eV")
    surface_anisotropy_max: float | None = Field(None, description="Maximum surface anisotropy")
    surface_anisotropy_min: float | None = Field(None, description="Minimum surface anisotropy")
    ...
    has_reconstructed: bool | None = Field(None, description="Whether the material has a reconstructed surface")
    has_props: list[HasProps | str] | None = Field(None, description="List of possible properties given by HasProps enum to search for.")
    deprecated: bool | None = Field(None, description="Whether the material is deprecated")
...
class ElasticitySchema(BaseModel):
    formula: str | None = Field(None, description="Query by formula including anonymized formula or by including wild cards. A comma delimited string list of anonymous formulas or regular formulas can also be provided.")
    chemsys: str | None = Field(None, description="A comma delimited string list of chemical systems. Wildcards for unknown elements only supported for single chemsys queries")
    k_voigt_max: float | None = Field(None, description="Maximum value for the Voigt average of the bulk modulus in GPa")
    k_voigt_min: float | None = Field(None, description="Minimum value for the Voigt average of the bulk modulus in GPa")
    k_reuss_max: float | None = Field(None, description="Maximum value for the Reuss average of the bulk modulus in GPa")
    k_reuss_min: float | None = Field(None, description="Minimum value for the Reuss average of the bulk modulus in GPa")
    k_vrh_max: float | None = Field(None, description="Maximum value for the Voigt-Reuss-Hill average of the bulk modulus in GPa")
    k_vrh_min: float | None = Field(None, description="Minimum value for the Voigt-Reuss-Hill average of the bulk modulus in GPa")
    g_voigt_max: float | None = Field(None, description="Maximum value for the Voigt average of the shear modulus in GPa")
    g_voigt_min: float | None = Field(None, description="Minimum value for the Voigt average of the shear modulus in GPa")
    g_reuss_max: float | None = Field(None, description="Maximum value for the Reuss average of the shear modulus in GPa")
    g_reuss_min: float | None = Field(None, description="Minimum value for the Reuss average of the shear modulus in GPa")
    g_vrh_max: float | None = Field(None, description="Maximum value for the Voigt-Reuss-Hill average of the shear modulus in GPa")
    g_vrh_min: float | None = Field(None, description="Minimum value for the Voigt-Reuss-Hill average of the shear modulus in GPa")
    elastic_anisotropy_max: float | None = Field(None, description="Maximum value for the elastic anisotropy")
    elastic_anisotropy_min: float | None = Field(None, description="Minimum value for the elastic anisotropy")
    poisson_max: float | None = Field(None, description="Maximum value for the Poisson ratio")
    poisson_min: float | None = Field(None, description="Minimum value for the Poisson ratio")
    sort_fields: str | None = Field(None, description="Comma-delimited list of fields to sort on. Prefix with - for descending order.")
    ...
    limit: int = Field(description="Fields to project from ElasticityDoc as a list of comma separated strings. Fields include: `pretty_formula` `chemsys` `elasticity` `task_id`")
    fields: str = Field(description="Fields to project from SummaryDoc as a list of comma separated strings. Fields include: `builder_meta` `nsites` `elements` `nelements` `composition` `composition_reduced` `formula_pretty` `formula_anonymous` `chemsys` `volume` `density` `density_atomic` `symmetry` `property_name` `material_id` `deprecated` `deprecation_reasons` `last_updated` `origins` `warnings` `structure` `task_ids` `uncorrected_energy_per_atom` `energy_per_atom` `formation_energy_per_atom` `energy_above_hull` `is_stable` `equilibrium_reaction_energy_per_atom` `decomposes_to` `xas` `grain_boundaries` `band_gap` `cbm` `vbm` `efermi` `is_gap_direct` `is_metal` `es_source_calc_id` `bandstructure` `dos` `dos_energy_up` `dos_energy_down` `is_magnetic` `ordering` `total_magnetization` `total_magnetization_normalized_vol` `total_magnetization_normalized_formula_units` `num_magnetic_sites` `num_unique_magnetic_sites` `types_of_magnetic_species` `k_voigt` `k_reuss` `k_vrh` `g_voigt` `g_reuss` `g_vrh` `universal_anisotropy` `homogeneous_poisson` `e_total` `e_ionic` `e_electronic` `n` `e_ij_max` `weighted_surface_energy_EV_PER_ANG2` `weighted_surface_energy` `weighted_work_function` `surface_anisotropy` `shape_factor` `has_reconstructed` `possible_species` `has_props` `theoretical` `database_IDs`")
    all_fields: bool | None = Field(False, description="Whether to return all fields in results")

class SynthesisSchema(BaseModel):
    keywords: str | None = Field(None, description="Comma-delimited list of keywords to search synthesis paragraph text with")
    synthesis_type: str | None = Field(None, description="Comma-delimited list of synthesis types to include. Options include: 'solid_state', 'sol_gel'")
    target_formula: str | None = Field(None, description="Chemical formula of the target material")
    precursor_formula: str | None = Field(None, description="Chemical formula of the precursor material")
    operations: str | None = Field(None, description="Comma-delimited list of operations that syntheses must have. Options include: 'starting', 'mixing', 'shaping', 'drying', 'heating', 'quenching'")
    condition_heating_temperature_max: float | None = Field(None, description="Maximum heating temperature in K")
    condition_heating_temperature_min: float | None = Field(None, description="Minimum heating temperature in K")
    condition_heating_time_max: float | None = Field(None, description="Maximum heating time in hours") # TODO: check if this is correct
    condition_heating_time_min: float | None = Field(None, description="Minimum heating time in hours")
    condition_heating_atmosphere: str | None = Field(
        None, 
        description="Comma-delimited list of required heating atmospheres", 
        examples=['air', 'oxygen', 'argon', 'nitrogen', 'hydrogen', 'vacuum', 'nirogen-oxygen'] # TODO: check if the example is the intended format
        )
...
class ThermoSchema(BaseModel):
    ...
    equilibrium_reaction_energy_per_atom_max: float | None = Field(None, description="Maximum equilibrium reaction energy per atom in eV/atom")
    equilibrium_reaction_energy_per_atom_min: float | None = Field(None, description="Minimum equilibrium reaction energy per atom in eV/atom")
    decomposition_enthalpy_max: float | None = Field(None, description="Maximum decomposition enthalpy in eV/atom")
    decomposition_enthalpy_min: float | None = Field(None, description="Minimum decomposition enthalpy in eV/atom")
    sort_fields: str | None = Field(None, description="Comma-delimited list of fields to sort on. Prefix with - for descending order.")
    # _page: int = Field(description="Page number to request (takes precedent over _limit and _skip)")
    # _per_page: int = Field(description="Number of entries to show per page (takes precedent over _limit and _skip). Limited to 1000")
    # _skip: int = Field(description="Number of entries to skip")
